...
import { DottedRevealAreaChart } from "@/charts/areacharts/dotted-reveal-areachart"
...
export default function AreaChartHome (){
  ...
  const components = [
    ...
    <ChartDisplay children = {<DottedRevealAreaChart/>} component = {<DottedRevealAreaChart/>} charttype="Dotted-Reveal" jsoncontent= {SmoothGradientAreachartJson.files[0].content} clicommand={`${clicommand}/smooth-gradient-areachart.json`}className="w-full"/>,
  ]
